...
local function deprecatedTip(old_name,new_name)
    if __disableDeprecatedTip then
        return
    end
...
function UICheckBoxDeprecated.addEventListenerCheckBox(self,handler)
    deprecatedTip("ccui.CheckBox:addEventListenerCheckBox","ccui.CheckBox:addUIEventListener")
    return self:addUIEventListener(handler)
end
...
function UISliderDeprecated.addEventListenerSlider(self,handler)
    deprecatedTip("ccui.Slider:addEventListenerSlider","ccui.Slider:addUIEventListener")
    return self:addUIEventListener(handler)
end
...
function UITextFieldDeprecated.addEventListenerTextField(self,handler)
    deprecatedTip("ccui.TextField:addEventListenerTextField","ccui.TextField:addUIEventListener")
    return self:addUIEventListener(handler)
end
...
function UIPageViewDeprecated.addEventListenerPageView(self,handler)
    deprecatedTip("ccui.PageView:addEventListenerPageView","ccui.PageView:addUIEventListener")
    return self:addUIEventListener(handler)
end
...
function UIScrollViewDeprecated.addEventListenerScrollView(self,handler)
    deprecatedTip("ccui.ScrollView:addEventListenerScrollView","ccui.ScrollView:addUIEventListener")
    return self:addUIEventListener(handler)
end
...
function UIListViewDeprecated.addEventListenerListView(self,handler)
    deprecatedTip("ccui.ListView:addEventListenerListView","ccui.ListView:addUIEventListener")
    return self:addUIEventListener(handler)
end
