--[[
    Filename:    WeaponsDescDialog.lua
    Author:      <qiaohuan@playcrab.com>
    Datetime:    2017-10-12 20:32:43
    Description: File description
--]]


local WeaponsDescDialog = class("WeaponsDescDialog", BasePopView)

function WeaponsDescDialog:ctor()
    WeaponsDescDialog.super.ctor(self)
end


function WeaponsDescDialog:onInit()
...
function WeaponsDescDialog:reflashUI(data)
    local str = lang("SIEGECON_RULE")
    print("str =======", str)
    -- " \
