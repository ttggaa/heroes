--[[
    Filename:    GuildRedDescDialog.lua
    Author:      <qiaohuan@playcrab.com>
    Datetime:    2016-06-07 16:37:27
    Description: File description
--]]

local GuildRedDescDialog = class("GuildRedDescDialog", BasePopView)

function GuildRedDescDialog:ctor()
    GuildRedDescDialog.super.ctor(self)
end


function GuildRedDescDialog:onInit()
...
function GuildRedDescDialog:reflashUI(data)
    

    local str = lang("RED_" .. data.wordType .. "_RULE")
    -- " \
