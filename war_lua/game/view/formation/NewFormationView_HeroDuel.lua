...
function NewFormationView:onInitEx()
    ...
    self._heroDuelInfo = {}
    self._heroDuelInfo._ui = self._layer_information:getChildByFullName("info_left.hero_duel_info")
    self._heroDuelInfo._ui:setVisible(true)
    self._heroDuelInfo._roundLeftGray = self._layer_information:getChildByFullName("info_left.hero_duel_info.image_round_gray_left")
    self._heroDuelInfo._labelRoundLeft = self._layer_information:getChildByFullName("info_left.hero_duel_info.label_my_round")
    self._heroDuelInfo._roundRightGray = self._layer_information:getChildByFullName("info_left.hero_duel_info.image_round_gray_right")
    self._heroDuelInfo._labelRoundRight = self._layer_information:getChildByFullName("info_left.hero_duel_info.label_enemy_round")
    self._heroDuelInfo._labelCountDown = self._layer_information:getChildByFullName("info_left.hero_duel_info.count_down_bg.label_count_down")
    ...
    self._imageOk = self._layer_information:getChildByFullName("btn_battle.image_ok")
