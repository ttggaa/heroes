--[[
    Filename:    TeamBoostDescDialog.lua
    Author:      <qiaohuan@playcrab.com>
    Datetime:    2016-10-31 21:49:05
    Description: File description
--]]


-- 兵团养成规则
local TeamBoostDescDialog = class("TeamBoostDescDialog", BasePopView)

function TeamBoostDescDialog:ctor()
    TeamBoostDescDialog.super.ctor(self)
end


function TeamBoostDescDialog:onInit()
...
function TeamBoostDescDialog:reflashUI(data)
