--[[
    Filename:    CrossSoloRuleView.lua
    Author:      <qiaohuan@playcrab.com>
    Datetime:    2017-12-01 17:26:31
    Description: File description
--]]

local CrossSoloRuleView = class("CrossSoloRuleView", BasePopView)

function CrossSoloRuleView:ctor()
    CrossSoloRuleView.super.ctor(self)
end


function CrossSoloRuleView:onInit()
...
function CrossSoloRuleView:reflashUI(data)
    local str = data.str or lang("cp_rule")
    print("str =======", str)
    -- " \
