...
-- Date: 2017-02-09 17:07:04
--
local HeroDuelRuleView = class("HeroDuelRuleView",BasePopView)
function HeroDuelRuleView:ctor()
    HeroDuelRuleView.super.ctor(self)

end

-- 初始化UI后会调用, 有需要请覆盖
function HeroDuelRuleView:onInit()
	self:registerClickEventByName("bg.closeBtn", function ()
        self:close()
        UIUtils:reloadLuaFile("heroduel.HeroDuelRuleView")
    end)
    ...
    -- 增加富文本
	local rtxStr = lang("HERODUEL_RULE1")  --lang("RULE_ARENA")
...
function HeroDuelRuleView:generateRanks()
