--[[
    Filename:    TestSceneHSBCView.lua
    Author:      <huachangmiao@playcrab.com>
    Datetime:    2017-03-15 21:01:24
    Description: File description
--]]

local TestSceneHSBCView = class("TestSceneHSBCView", BaseView)

function TestSceneHSBCView:ctor()
    TestSceneHSBCView.super.ctor(self)

end


function TestSceneHSBCView:onInit()
...
function TestSceneHSBCView:changeBg(index)
    self._bg:setTexture("asset/uiother/map/_0000_pve_daditu"..index..".jpg")
end

function TestSceneHSBCView:imageLoadDone()
    self._sliderDatas = 
    {
        {-50, 3.6, 0, "色相"},
        {-50, 2, 0, "饱和度"},
...
function TestSceneHSBCView:initSlider()
    local x, y = 50, 140
    local inx = 80
...
function TestSceneHSBCView:onValueChange()
