--[[
    Filename:    MFDescDialog.lua
    Author:      <qiaohuan@playcrab.com>
    Datetime:    2016-07-11 20:38:59
    Description: File description
--]]

-- 航海规则
local MFDescDialog = class("MFDescDialog", BasePopView)

function MFDescDialog:ctor()
    MFDescDialog.super.ctor(self)
end


function MFDescDialog:onInit()
...
function MFDescDialog:reflashUI(data)
    

    local str = lang("MF_RULE")
    print("str =======", str)
    -- " \
