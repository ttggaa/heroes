--[[
    Filename:    CityBattleDescDialog.lua
    Author:      <qiaohuan@playcrab.com>
    Datetime:    2016-11-28 15:38:27
    Description: File description
--]]

-- GVG规则

local CityBattleDescDialog = class("CityBattleDescDialog", BasePopView)

function CityBattleDescDialog:ctor()
    CityBattleDescDialog.super.ctor(self)
end


function CityBattleDescDialog:onInit()
...
function CityBattleDescDialog:reflashUI(data)
