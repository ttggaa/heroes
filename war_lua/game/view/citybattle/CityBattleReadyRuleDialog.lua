...
--[[
    Filename:    CityBattleReadyRuleDialog.lua
    Author:      <lishunan@playcrab.com>
    Datetime:    2017-07-04 15:40:56
    Description: File description
--]]



local CityBattleReadyRuleDialog = class("CityBattleReadyRuleDialog",BasePopView)
function CityBattleReadyRuleDialog:ctor()
    CityBattleReadyRuleDialog.super.ctor(self)

end

-- 初始化UI后会调用, 有需要请覆盖
function CityBattleReadyRuleDialog:onInit()
	self:registerClickEventByName("bg.closeBtn", function ()
        self:close()
        UIUtils:reloadLuaFile("citybattle.CityBattleReadyRuleDialog")
    end)
    ...
    -- 增加富文本
	local rtxStr = lang("RULE_CITYBATTLE_PREPARE")  --lang("RULE_ARENA")
    ...
    rtx:setName("rtx")
    rtx:setPosition(-w* 0.5,maxHeight + 70)
    ...
    -- des2:setPosition(3, maxHeight + 50)
...
function CityBattleReadyRuleDialog:generateRanks()
...
return CityBattleReadyRuleDialog