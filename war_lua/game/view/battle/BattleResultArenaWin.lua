--[[
    Filename:    BattleResultArenaWin.lua
...
local BattleResultArenaWin = class("BattleResultArenaWin", BasePopView)

function BattleResultArenaWin:ctor(data)
    BattleResultArenaWin.super.ctor(self)
    self._result = data.result
    self._callback = data.callback
    self._battleInfo = data.result
    -- dump(self._battleInfo,"self._battleInfo")
end
function BattleResultArenaWin:getBgName()
    return "battleResult_bg.jpg"
end
function BattleResultArenaWin:onInit()
...
function BattleResultArenaWin:initLabel(node,isGreen)     
    if isGreen then
...
function BattleResultArenaWin:animNext(mc2)
    local animPos = self:getUI("bg.animPos")
...
function BattleResultArenaWin.dtor()
    BattleResultArenaWin = nil
    delaytick = nil
end

return BattleResultArenaWin