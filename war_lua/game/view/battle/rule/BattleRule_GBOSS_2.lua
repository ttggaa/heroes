--[[
    Filename:    BattleRule_GBOSS_2.lua
...
local ADD_DEMAGE_RACEID_1 = 103
local ADD_DEMAGE_RACEID_2 = 106
...
function BattleLogic:bossSkillAction3()
    ...
    delayCall(26 * 0.05, self, function ()
        ...
        if team then
            ...
            objLayer:rangeAttackPt(self._boss.ID, team.x, team.y, 0, 300, 2, "shijurendandao", dis, 200)
