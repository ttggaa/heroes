--[[
    Filename:    BattleRule_GBOSS_3.lua
...
local ADD_DEMAGE_RACEID_1 = 104
local ADD_DEMAGE_RACEID_2 = 105
...
function BattleLogic:bossSkillAction3()
    ...
    delayCall(26 * 0.05, self, function ()
        ...
        if team then
            ...
            objLayer:rangeAttackPt(self._boss.ID, team.x, team.y, 0, 300, 2, "huojurendandao", dis, 200)
