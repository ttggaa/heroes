--[[
    Filename:    BattleRule_Siege.lua
    Author:      huachangmiao@playcrab.com
    Datetime:    2015-10-19 16:37:44
...
function BattleLogic:onTeamDieEx(team)
    if team.camp == camp1 then
        self.__teamDieCount1 = self.__teamDieCount1 + 1
        if self._assist == 1 and self._assistValue == self.__teamDieCount1 then
            -- 触发支援
            self:doAssist()
        end
    end
